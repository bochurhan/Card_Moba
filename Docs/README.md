...
3. 然后看 **[TechGuide/SystemArchitecture_V2.md](TechGuide/SystemArchitecture_V2.md)** — 理解当前模块分层关系

### 我想添加新卡牌

1. 理解卡牌规则：[GameDesign/CardSystem.md](GameDesign/CardSystem.md)
2. 查看当前卡牌与配置契约：[TechGuide/ConfigSystem.md](TechGuide/ConfigSystem.md)
...
3. 代码层面：[TechGuide/SystemArchitecture_V2.md](TechGuide/SystemArchitecture_V2.md)
...
1. **枚举变更**：修改 `Shared/Protocol/Enums/EffectType.cs` 后同步更新 `TechGuide/ConfigSystem.md`，必要时补充 `GameDesign/SettlementRules.md`
2. **架构变更**：更新 `TechGuide/SystemArchitecture_V2.md` 并同步 `Planning/TODO.md`
3. **玩法变更**：更新对应 `GameDesign/` 文档并同步版本号
4. **版本号**：重大变更时在文档顶部更新版本号和日期
5. **Handler 新增**：以 `Shared/BattleCore/` 实际代码和 `TechGuide/SystemArchitecture_V2.md` 为准，不再参考旧版 `BattleCore.md` 正文
